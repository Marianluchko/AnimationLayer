...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Antourage/AntViewer/MyFrameworks/ViewerExtension.xcframework" "" "true" "ios-arm64_x86_64-simulator/ViewerExtension.framework" "ios-arm64/ViewerExtension.framework"
fi
